...
function AfterDownload()
	...
	if DOWNLOAD_COUNT == 0 then
		...
		print("<b><font color=\"#6699FF\">Irelia - Hiten Style:</font></b> <font color=\"#FFFFFF\">Required libraries downloaded successfully, please reload (double F9).</font>")
	end
end
...
local UPDATE_NAME = "Irelia - Hiten Style"
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/DraconisBoL/BoL/master/Irelia%20-%20Hiten%20Style.lua" .. "?rand=" .. math.random(1, 10000)
...
function OnLoad()
	print("<b><font color=\"#6699FF\">Irelia - Hiten Style:</font></b> <font color=\"#FFFFFF\">Sucessfully loaded!</font>")
	Variables()
	Menu()
	PriorityOnLoad()
end
...
function Menu()
	Settings = scriptConfig("Irelia - Hiten Style "..version.."", "DraconisIrelia")
	
	Settings:addSubMenu("["..myHero.charName.."] - Combo Settings", "combo")
		Settings.combo:addParam("comboKey", "Combo Key", SCRIPT_PARAM_ONKEYDOWN, false, 32)
		Settings.combo:addParam("useR", "Use "..SkillR.name.." (R) in Combo", SCRIPT_PARAM_ONOFF, true)
		Settings.combo:addParam("useE", "Use "..SkillE.name.." (E) in Combo", SCRIPT_PARAM_LIST, 2, { "No", "Wait for stun", "Always" })
...
function PriorityOnLoad()
	if heroManager.iCount < 10 or (TwistedTreeline and heroManager.iCount < 6) then
		print("<b><font color=\"#6699FF\">Irelia - Hiten Style:</font></b> <font color=\"#FFFFFF\">Too few champions to arrange priority.</font>")
